...
if (Validar_Nivel("Todos los niños")) {
    $sql = $database->prepare('SELECT p.parzcodg FROM tabparez AS p WHERE p.perscedi = ? AND p.nñcedesc = ?');
    $sql->bind_param("ss", $_SESSION['cedula'], $niño);
    $sql->execute();
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading">
                        <h2><?php echo "Niño " . $niño; ?></h2>
                    </div>
                </div>

                <div id="planilla" class="col-md-12 row">
                    <div id="info">
                        <div class="foto_perfil"><img src="../../assets/avatars/STAND.webp" alt="Foto de Perfil"></div>
                        <div class="datos">
                            <p>Cedula Escolar: 12347</p>
                            <p>Nombres: A A</p>
                            <p>Apellidos: I I</p>
                            <p>Genero Masculino</p>
                            <p>Fecha de nacimiento: 14/02/2022</p>
                            <p>Lugar de Nacimineto: Santa Teresa, debajo de un puente</p>
                            <p>Direccion: blablablablabla, parroquia, municipio, ciudad, estado, pais</p>
                            <p>Numero de hermanos dentro de la institucion: 11</p>
                            <p>Metodos de Transporte: vehiculo propio</p>
